...
adb shell pm clear io.chaldeaprjkt.gamespace
adb shell pm disable-user --user 0 io.chaldeaprjkt.gamespace
adb shell pm clear im.angry.openeuicc
adb shell pm disable-user --user 0 im.angry.openeuicc
# adb shell pm clear
